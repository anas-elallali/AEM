...
import fr.santech.aem.repository.AddressRepository;
import fr.santech.aem.service.AddressService;
import fr.santech.aem.service.dto.AddressDTO;
import fr.santech.aem.service.mapper.AddressMapper;
...
public class AddressResourceIT {
    ...
    private static final AddressType DEFAULT_TYPE = AddressType.PUBLIC;
    private static final AddressType UPDATED_TYPE = AddressType.INDIVIDUAL;
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getAdditional()).isEqualTo(DEFAULT_ADDITIONAL);
    ...
    public void updateAddress() throws Exception {
        ...
        assertThat(testAddress.getAdditional()).isEqualTo(UPDATED_ADDITIONAL);
